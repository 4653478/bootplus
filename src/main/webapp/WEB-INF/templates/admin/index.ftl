...
<div id="page-wrapper" class="gray-bg dashbard-1">
    <div class="row border-bottom">
        <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <a _ngcontent-c2="" href="https://github.com/4653478/SpringBoot_MyBatisPlus" target="_blank">
                        <img _ngcontent-c2="" alt="star"
                             src="https://img.shields.io/github/stars/4653478/SpringBoot_MyBatisPlus.svg?style=white&amp;label=Stars">
                    </a>
                </li>--]
            </ul>
        </nav>
    ...
    <div class="footer">
        <div class="pull-right">© 2018-2022 age
        </div>
    </div>
</div>
</body>
