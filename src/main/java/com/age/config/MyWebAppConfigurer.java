...
import com.age.config.aop.annotation.MyAutowired;
import com.age.config.interceptor.LogInterceptor;
import com.age.util.file.FileUtils;
...
//        registry.addViewController("/").setViewName("forward:/admin");
     ...
     * 文件上传保存路径
     */
    @Value("${file.UploadPath:#{T(com.age.util.file.FileUtils).FILE_PREFIX + myWebAppConfigurer.FILE_UPLOAD_PATH}}")
