...
import com.age.common.enums.EnumUtil;
import com.age.common.enums.IEnum;
 ...
 * <p>
 * 用法一:
 * 入库：#{enumDataField, typeHandler=com.age.common.typehandler.IEnumTypeHandler}
 * <p>
 * 出库：
 * <resultMap>
 * <result property="enumDataField" column="enum_data_field" javaType="com.xxx.MyEnum" typeHandler="com.age.common.typehandler.IEnumTypeHandler"/>
 * </resultMap>
 * <p>
 * 用法二： 1）在mybatis-config.xml中指定handler:
 * <typeHandlers>
 * <typeHandler handler="com.age.common.typehandler.IEnumTypeHandler" javaType="com.xxx.MyEnum"/>
 * </typeHandlers>
 * <p>
 ...
 *
 * @author Created by age on 2020/4/1
 * @see com.age.common.enums.IEnum
 * 默认枚举处理类
