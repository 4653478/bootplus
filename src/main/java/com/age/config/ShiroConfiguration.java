...
import com.age.shiro.UserRealm;
...
//        sessionManager.setSessionListeners(listeners);
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // noSessionCreation
        //filterChainDefinitionMap.put("/**", "anon");//为微信小程序业务域名验证根目录，临时添加
        filterChainDefinitionMap.put("/statics/**", "anon");
        filterChainDefinitionMap.put("/admin/order/**", "anon");//odrer下的业务为查询返回Json，不需要登录
        filterChainDefinitionMap.put("/admin/sys/ahuser/**", "anon");//ahuser下的接口，不需要登录
