...
import com.age.datasources.DynamicDataSource;
...
public class DataSourceConfig {
    ...
    @Value("${custom.datasource.dsrw.url}")
    private String dbUrl2;

    @Value("${custom.datasource.dsrw.username}")
    private String username2;

    @Value("${custom.datasource.dsrw.password}")
    private String password2;

    @Value("${custom.datasource.dsrw.driverClassName}")
    ...
    public ServletRegistrationBean druidServletRegistrationBean() {
        ...
        // 登录查看信息的账号密码.
        servletRegistrationBean.addInitParameter("loginUsername", "age");
    ...
    public DynamicDataSource dynamicDataSource() throws SQLException {
        ...
        targetDataSources.put(DataSourceContextHolder.DATA_SOURCE_RW, dataSource2);
